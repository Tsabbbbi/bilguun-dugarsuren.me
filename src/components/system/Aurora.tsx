...
// Backslash-newlines inside the #define macro are literal GLSL line continuations.
// They must be written as \\ in the JS template literal to survive into the string.
...
export function Aurora({
  colorStops = ['#163832', '#8EB69B', '#E6E8E2'],
  amplitude = 1.2,
  blend = 0.6,
  speed = 0.4,
}: AuroraProps) {
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      program.uniforms.uTime.value      = t * 0.001 * (p.speed ?? 0.4)
